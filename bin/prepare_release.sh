...
CREATE_REACT_CLASS_DIR="$VENDOR_DIR/create-react-class"
CREATE_REACT_CLASS_NOTICE="$CREATE_REACT_CLASS_DIR/CREATE_REACT_CLASS_IN_EZPLATFORMADMINUIASSETS.txt"
PROP_TYPES_DIR="$VENDOR_DIR/prop-types"
PROP_TYPES_NOTICE="$PROP_TYPES_DIR/PROP_TYPES_IN_EZPLATFORMADMINUIASSETS.txt"
